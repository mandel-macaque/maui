...
namespace Microsoft.Maui.Platform
{
	...
	{
		public const string TextSetOrChangedNotification = "TextSetOrChanged";
		...
		public void TextSetOrChanged() {
				var notification = NSNotification.FromName(TextSetOrChangedNotificatio, this);
